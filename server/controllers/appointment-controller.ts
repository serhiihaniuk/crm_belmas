...
class AppointmentController {
    async createAppointment({AppointmentInput}: { AppointmentInput: AppointmentGQLInput }): Promise<IAppointmentRaw> {
        try {
            ...
            const appointmentRaw: IAppointmentRaw = {...savedAppointment._doc, _id: savedAppointment._id};

            return appointmentRaw
        } catch (err) {
            throw err;
        }
    }
